...
public class MyGame extends Lol {
    ...
    public void configure() {
        ...
        mDefaultFontSize = 32;
        mDefaultFontRed = 55;
        mDefaultFontGreen = 113;
        mDefaultFontBlue = 228;
        mDefaultWinText = "You did it!";
        mDefaultLoseText = "Try again; you can do it!";
        mGameTitle = "Stairway to Heaven";
        mEnableChooser = false;
    ...
    public void loadResources() {
        ...
        Media.registerImage("bun.png");
        Media.registerImage("cloud.png");
//        Media.registerImage("rclo-ud.png");
//        Media.registerImage("ocloud.png");
//        Media.registerImage("ycloud.png");
//        Media.registerImage("gcloud.png");
//        Media.registerImage("lbcloud.png");
//        Media.registerImage("bcloud.png");
//        Media.registerImage("pcloud.png");
        Media.registerImage("background.PNG");
        Media.registerImage("carrot.png");
        Media.registerImage("theTrueBackground2.png");
        Media.registerImage("hop.png");
        ...
        Media.registerMusic("bun.ogg", true);
    }
}
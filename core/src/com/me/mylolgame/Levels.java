...
public class Levels implements ScreenManager {
    ...
    public void display(int whichLevel) {
        ...
        if (whichLevel == 1) {
            ...
            Physics.configure(0, -12);
            //Tilt.enable(10, 10);
            PreScene.get().addImage("theTrueBackground2.png", 0, 0, 960, 640);
            Level.setMusic("bun.ogg");
            PreScene.get().addText("You're a rabbit aiming for the top; grab all the carrots to win!\nHold left to go left\nHold right to go right\nHit the side of the clouds for a boost!\n \nTap to begin", 255, 255, 255, "arial.ttf",
                    32);
            Util.drawBoundingBox(0, 0, 48, 32, "red.png", 1, .3f, 1);

            Random r = new Random();
            Util.drawPicture(0, 0, 48, 32, "theTrueBackground2.png", 0);

            Hero h = Hero.makeAsBox(25, 15, 3, 4, "bun.png");
            h.setPhysics(.05f, 0f, 0f);
            h.setPassThrough(7);
            h.setMoveByTilting();
            h.setJumpImpulses(0, 30);
            h.disableRotation();
            //h.setDefaultReverseAnimation(new Animation(".png", 1, true).to(0, 1000));
            //dh.setDefaultAnimation(new Animation("mustardball.png", 1, true).to(0, 1000));
            Control.addLeftButton(0, 0, 500, 700, "", 10, h);
            Control.addRightButton(500, 0, 500, 700, "", 10, h);
//            Destination.makeAsCircle(29, 6, 2, 2, "mustardball.png");


            Obstacle platform = Obstacle.makeAsBox(0, 1, 48, .2f, "fade.png");


            Enemy.makeAsBox(0, 0.1f, 48, .1f, "cloud.png");

            platform.setPhysics(0,0,0);
            platform.setSpeedBoost(0,15);
            platform.addVelocity(0,-4.3f,true);



            // platform.addVelocity(0,10,true); // allows platforms to move vertically or wherever
            ...
            /**
             ...
             {
             int rX = r.nextInt(48);
             int rWidth = r.nextInt(10);


             Obstacle platform2 = Obstacle.makeAsBox(rX, i, rWidth, .2f, "red.png");

             platform2.setPhysics(0,0,0);
             platform2.setSpeedBoost(0,20);
             platform2.addVelocity(0,-4.3f,true);
             }
            ...
            for(int i = 0; i < 40; i+=40) {
                Obstacle platform2 = Obstacle.makeAsBox(24, i+10, 24, .5f, "cloud.png");

                platform2.setPhysics(0, 0, 0);
                platform2.setSpeedBoost(0, 15);
                platform2.addVelocity(0, -4.3f, true);

                Obstacle platform3 = Obstacle.makeAsBox(0, i+20, 14, .5f, "cloud.png");

                platform3.setPhysics(0, 0, 0);
                platform3.setSpeedBoost(0, 15);
                platform3.addVelocity(0, -4.3f, true);

                Obstacle platform4 = Obstacle.makeAsBox(38, i+20, 14, .5f, "cloud.png");

                platform4.setPhysics(0, 0, 0);
                platform4.setSpeedBoost(0, 15);
                platform4.addVelocity(0, -4.3f, true);

                Obstacle platform5 = Obstacle.makeAsBox(0, i+30, 30, .5f, "cloud.png");

                platform5.setPhysics(0, 0, 0);
                platform5.setSpeedBoost(0, 15);
                platform5.addVelocity(0, -4.3f, true);

                Obstacle platform6 = Obstacle.makeAsBox(0, i+40, 5, .5f, "cloud.png");

                platform6.setPhysics(0, 0, 0);
                platform6.setSpeedBoost(0, 15);
                platform6.addVelocity(0, -4.3f, true);

                Obstacle platform7 = Obstacle.makeAsBox(15, i+40, 10, .5f, "cloud.png");

                platform7.setPhysics(0, 0, 0);
                platform7.setSpeedBoost(0, 15);
                platform7.addVelocity(0, -4.3f, true);

                Obstacle platform8 = Obstacle.makeAsBox(33, i+40, 20, .5f, "cloud.png");

                platform8.setPhysics(0, 0, 0);
                platform8.setSpeedBoost(0, 15);
                platform8.addVelocity(0, -4.3f, true);
            ...
            for(int i = 40; i < 80; i+=80) {

                Obstacle platform2 = Obstacle.makeAsBox(7, i+10, 5, .5f, "cloud.png");

                platform2.setPhysics(0, 0, 0);
                platform2.setSpeedBoost(0, 15);
                platform2.addVelocity(0, -4.3f, true);

//                Goodie lit = Goodie.makeAsCircle(30, i+10, 2, 2, "blueball.png");
//
//                lit.setPhysics(0, 0, 0);
//                Obstacle platform3 = Obstacle.makeAsBox(30, i+10, 7, .5f, "red.png");
//                Obstacle platform3 = Obstacle.makeAsCircle(20, i+10, 3.5f, 3.5f, "purpleball.png");
//                platform3 = Obstacle.makeAsCircle(20, i+10, 3.5f, 3.5f, "purpleball.png");




//                platform3.setPhysics(0, 0, 0);
//                platform3.setSpeedBoost(0, 30);
//                platform3.addVelocity(0, -4.3f, true);


                Obstacle platform4 = Obstacle.makeAsBox(0, i+20, 5, .5f, "cloud.png");

                platform4.setPhysics(0, 0, 0);
                platform4.setSpeedBoost(0, 15);
                platform4.addVelocity(0, -4.3f, true);

                Obstacle platform5 = Obstacle.makeAsBox(24, i+20, 24, .5f, "cloud.png");

                platform5.setPhysics(0, 0, 0);
                platform5.setSpeedBoost(0, 15);
                platform5.addVelocity(0, -4.3f, true);

                Obstacle platform6 = Obstacle.makeAsBox(10, i+30, 20, .5f, "cloud.png");

                platform6.setPhysics(0, 0, 0);
                platform6.setSpeedBoost(0, 15);
                platform6.addVelocity(0, -4.3f, true);

                Obstacle platform7 = Obstacle.makeAsBox(0, i+40, 14, .5f, "cloud.png");

                platform7.setPhysics(0, 0, 0);
                platform7.setSpeedBoost(0, 15);
                platform7.addVelocity(0, -4.3f, true);

                Obstacle platform8 = Obstacle.makeAsBox(4, i+40, 24, .5f, "cloud.png");
            ...
            for(int i = 80; i < 120; i+=120) {

                Obstacle platform2 = Obstacle.makeAsBox(24, i+10, 10, .5f, "cloud.png");
...
//                Obstacle platform4 = Obstacle.makeAsBox(34, i+20, 10, .5f, "cloud.png");
//
//                platform4.setPhysics(0, 0, 0);
//                platform4.setSpeedBoost(0, 15);
//                platform4.addVelocity(0, -4.3f, true);

                Obstacle platform5 = Obstacle.makeAsBox(0, i+30, 10, .5f, "cloud.png");

                platform5.setPhysics(0, 0, 0);
                platform5.setSpeedBoost(0, 15);
                platform5.addVelocity(0, -4.3f, true);

                Obstacle platform6 = Obstacle.makeAsBox(20, i+30, 10, .5f, "cloud.png");

                platform6.setPhysics(0, 0, 0);
                platform6.setSpeedBoost(0, 15);
                platform6.addVelocity(0, -4.3f, true);

                Obstacle platform7 = Obstacle.makeAsBox(14, i+40, 20, .5f, "cloud.png");
...
//                platform3.addVelocity(0, -4.3f, true);
            ...
            Goodie g2 = Goodie.makeAsBox(20, 45, 2, 4, "carrot.png");
            g2.addVelocity(0,-4.3f,true);
            Goodie g3 = Goodie.makeAsBox(20, 85, 2, 4, "carrot.png");
            g3.addVelocity(0,-4.3f,true);
            Goodie g4 = Goodie.makeAsBox(7, 115, 2, 4, "carrot.png");
            g4.addVelocity(0,-4.3f,true);
            Goodie g5 = Goodie.makeAsBox(25, 155, 2, 4, "carrot.png");
            g5.addVelocity(0,-4.3f,true);
            Goodie g6 = Goodie.makeAsBox(15, 195, 2, 4, "carrot.png");
            g6.addVelocity(0,-4.3f,true);

            Destination d = Destination.makeAsCircle(20, 245, 2, 2, "mustardball.png");
            Score.setVictoryDestination(1);
            d.setActivationScore(5, 0, 0, 0);
            d.addVelocity(0, -4.3f, true);
         ...
         */
            ...
            LolCallback sc = new LolCallback() {
                public void onEvent() {
                    ...
                    // as a reward... picking in the range 0-4.3f6,0-4.3f0 ensures
         ...
         */
            ...
            Obstacle o = Obstacle.makeAsPolygon(10, 10, 2, 5, "blueball.png", -1, 2, -1, 0, 0, -4.3f, 1, 0, 1, 1);
